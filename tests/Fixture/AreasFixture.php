...
class AreasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'area' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'utf16_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'created' => '2016-08-16 07:28:02',
            'modified' => '2016-08-16 07:28:02'
        ],
    ];
}
