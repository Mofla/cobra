    ...
    <nav class="top-bar expanded" data-topbar role="navigation">
        ...
        <div class="top-bar-section">
            ...
            <?php
                ...
                {
                ?>
                <li><?= $this->Html->link(__('Mon profil'),['controller' => 'Users', 'action' => 'view',$this->request->session()->read('Auth.User.id')]) ?></li>
                ...
                <li><?= $this->Html->link(__('S\'inscrire'),['controller' => 'Users', 'action' => 'add']) ?></li>
                <?php
                }
                ?>
